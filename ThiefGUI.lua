...
local Themes = {
	...
	MyText = {
    MainFrame = Color3.fromRGB(40, 40, 40), -- Màu nền chính
    Minimise = Color3.fromRGB(85, 85, 85), -- Màu nút thu nhỏ
    MinimiseAccent = Color3.fromRGB(85, 85, 85), -- Màu nút thu nhỏ (nhấn)
    Maximise = Color3.fromRGB(60, 60, 60), -- Màu nút phóng to
    MaximiseAccent = Color3.fromRGB(60, 60, 60), -- Màu nút phóng to (nhấn)
    NavBar = Color3.fromRGB(240, 230, 0), -- Màu thanh điều hướng
    NavBarAccent = Color3.fromRGB(255, 255, 255), -- Màu thanh điều hướng (nhấn)
    NavBarInvert = Color3.fromRGB(15, 15, 15), -- Màu chữ trên thanh điều hướng
    TitleBar = Color3.fromRGB(240, 230, 0), -- Màu thanh tiêu đề
    TitleBarAccent = Color3.fromRGB(255, 255, 255), -- Màu thanh tiêu đề (nhấn)
    Overlay = Color3.fromRGB(219, 68, 103), -- Màu lớp phủ
    Banner = Color3.fromRGB(255, 255, 255), -- Màu banner
    BannerAccent = Color3.fromRGB(219, 68, 103), -- Màu banner (nhấn)
    Content = Color3.fromRGB(40, 40, 40), -- Màu nội dung
    Button = Color3.fromRGB(219, 68, 103), -- Màu nút
    ButtonAccent = Color3.fromRGB(255, 255, 255), -- Màu nút (nhấn)
    ChipSet = Color3.fromRGB(219, 68, 103), -- Màu chip set
    ChipSetAccent = Color3.fromRGB(255, 255, 255), -- Màu chip set (nhấn)
    DataTable = Color3.fromRGB(219, 68, 103), -- Màu bảng dữ liệu
    DataTableAccent = Color3.fromRGB(255, 255, 255), -- Màu bảng dữ liệu (nhấn)
    Slider = Color3.fromRGB(255, 255, 255), -- Màu trượt
    SliderAccent = Color3.fromRGB(219, 68, 103), -- Màu trượt (nhấn)
    Toggle = Color3.fromRGB(219, 68, 103), -- Màu công tắc
    ToggleAccent = Color3.fromRGB(255, 255, 255), -- Màu công tắc (nhấn)
    Dropdown = Color3.fromRGB(255, 255, 255), -- Màu dropdown
    DropdownAccent = Color3.fromRGB(219, 68, 103), -- Màu dropdown (nhấn)
    ColorPicker = Color3.fromRGB(255, 255, 255), -- Màu bảng chọn màu
    ColorPickerAccent = Color3.fromRGB(219, 68, 103), -- Màu bảng chọn màu (nhấn)
    TextField = Color3.fromRGB(175, 175, 175), -- Màu ô văn bản
    TextFieldAccent = Color3.fromRGB(255, 255, 255), -- Màu ô văn bản (nhấn)
}
...
function Material.Load(Config)
	...
	local Title = Config.Title or "AutoPlayer"
